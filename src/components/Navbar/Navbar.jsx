    ...
    <>
      ...
      >
        <nav className="flex items-center justify-between w-full relative">
          ...
          <div>
            <img
              src={isScrolled ? (DarkMode ? LogoLight : LogoDark) : LogoLight}
            ...
            <div className="hidden sm:block">
              <div className="flex items-center justify-center">
                ...
                <span
                  className={`${
                    isScrolled
                      ? "bg-[#3758f9] text-white hover:bg-blue-800"
                      : "bg-white/15 hover:bg-white hover:text-black text-white"
                  } px-5 py-[6px] font-semibold   backdrop-blur-lg font-sans cursor-pointer  duration-200   rounded-md`}
                >
