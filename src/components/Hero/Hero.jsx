...
import dottedIMG from "../../assets/team/dotted-shape.svg";
function Hero() {
  return (
    <>
      <section
        id="hero-section"
        className="w-full pt-20 bg-[#3758f9] h-auto overflow-hidden"
      >
        <div className="flex flex-col items-center justify-center">
          <h1 className="text-[30px] md:text-[45px] font-sans font-bold text-center text-white mt-10">
            Open-Source Web Template for <br /> SaaS, Startup, Apps, and More
          </h1>
          <p className="text-[17px] mt-5 font-sans font-semibold text-white text-center">
            Multidisciplinary Web Template Built with Your Favourite Technology{" "}
            <br />- HTML Bootstrap, Tailwind and React NextJS.
          </p>
          <div className="flex items-center justify-center gap-5 mt-10 flex-wrap ">
            <button className="px-6 py-3 hover:text-gray-500 duration-200 font-sans font-semibold bg-white text-black rounded-md">
              Download Now
            </button>
            <button className="px-6 py-3 font-sans font-semibold flex items-center    gap-2 bg-white/15  text-white  hover:bg-white duration-200 hover:text-black  rounded-md">
              <FaGithub className="text-[20px]" /> Star on Github
            </button>
          </div>

          <p className="text-md font-sans font-semibold text-white mt-7 mb-4">
            Built with latest technology
          </p>
          <div className="flex items-center justify-center gap-4">
            <svg
              className="fill-current text-white/30 w-[35px] hover:text-white cursor-pointer duration-300"
              width="41"
              height="32"
              viewBox="0 0 41 32"
              fill="none"
            ...
            <svg
              className="mt-0.5 fill-current text-white/30  w-[35px] hover:text-white cursor-pointer duration-300"
              width="30"
              height="38"
              viewBox="0 0 30 38"
              fill="none"
          ...
          {/* hero image */}
          <div className="w-[80%] md:w-[60%] relative mt-10">
            <img
              src={HeroIMG}
              alt=""
              className="w-[100%] rounded-t-xl relative z-10"
            />
