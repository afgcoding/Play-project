  ...
  return (
    <>
      <div className={` mt-16 w-full px-14 `}>
        ...
        {/* card div */}
        <div className="mt-16 w-ful flex items-center justify-center gap-y-28 md:gap-y-36 gap-x-2 flex-wrap ">
          <div className="w-full lg:w-[280px] md:w-[200px]  h-40 group">
            <div className="relative ">
              <div className="w-[65px] h-[65px] transform group-hover:rotate-[60deg] duration-300 rotate-[30deg] rounded-2xl bg-blue-700/20"></div>
              <div className="w-[65px] h-[65px] rounded-xl bg-[#3758f9] absolute top-0 flex items-center justify-center">
                <svg
                  width="37"
                  height="37"
                  viewBox="0 0 37 37"
            ...
            <h1
              className={`${
                DarkMode ? "text-white" : "text-black"
              } text-xl font-sans font-bold mt-6 mb-3`}
            >
