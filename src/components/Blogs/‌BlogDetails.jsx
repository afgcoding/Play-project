...
import author from "../../assets/blog/author-01.png";
import { FaCalendar, FaComment, FaEye } from "react-icons/fa";
import ar1 from "../../assets/blog/article-author-01.png";
import ar2 from "../../assets/blog/article-author-02.png";
import ar3 from "../../assets/blog/article-author-03.png";
import ar4 from "../../assets/blog/article-author-04.png";
...
function BlogDetails({ DarkMode }) {
  return (
    <>
      <div className="mt-44">
        {/* text div */}
        <div className="text-center pb-10 shadow-sm">
          <h1
        ...
        <div className="px-16 flex flex-wrap lg:flex-nowrap  items-center justify-center gap-10 mt-16">
          <div
            className={`flex flex-col gap-6 w-[100%] lg:w-[66%]  ${
              DarkMode ? "text-white" : "text-black"
            }`}
          >
            <div className="flex flex-col gap-6">
              ...
              <p className="text-gray-600 text-sm dark:text-gray-400">
                ...
                for reviews. For instance: you should not asking for a review on
                ...
                don&apos;t want to have any unnecessary elements or Call To
                Actions.
              </p>
              <p className="text-gray-600 text-sm dark:text-gray-400">
                Thereapos;s a time and place for everything… including asking
                for reviews. For instance: you should not asking for a review on
                your checkout page. The sole purpose of this page is to guide
                your customer to complete their purchase, and this means that
                the page should be as minimalist and pared-down possible. You
                donapos;t want to have any unnecessary elements or Call To
                Actions.
              </p>
              ...
              <div
                className={`flex flex-col justify-center items-center rounded-sm py-9 px-32 gap-1  ${
                  DarkMode ? "bg-gray-800" : "bg-gray-300/40"
                }`}
              >
                <div>
          ...
          <div>
            <div className="flex flex-col gap-5">
              <div className="w-[80vw] flex items-center justify-center flex-col lg:w-[350px]  pl-1 md:relative md:top-0 bg-[#3758f9] text-white rounded-md py-12 md:py-12 md:h-[330px] shadow-xl">
              ...
              <div
                className={`flex flex-row flex-wrap gap-7 lg:gap-3 lg:flex-col text-gray-500 `}
              >
        ...
        <div
          className={`mt-14 mb-10  ${DarkMode ? "text-white" : "text-black"}`}
        >
